...
export CGO_CFLAGS="-I${PWD}/include -g -O2 `$LLVMCONFIG --cflags` --target=x86_64-linux-ohos --sysroot=$OHOS_NDK_HOME/native/sysroot"
export CGO_LDFLAGS="--target=x86_64-linux-ohos -fuse-ld=lld -L${PWD}/dist/x86_64"